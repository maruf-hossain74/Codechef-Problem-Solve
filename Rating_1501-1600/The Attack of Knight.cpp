...
int32_t main() {
    ...
    while(t--) {
        ...
        for(int i = 1; !ans && i < 9; i++) {
            for(int j = 1; j < 9; j++) {
                int cnt = 0;
                if((i+2 == x && j+1 == y) || (i+2 == x && j-1 == y) || (i-2 == x && j+1 == y) || (i-2 == x && j-1 == y) || (i+1 == x && j+2 == y) || (i+1 == x && j-2 == y) || (i-1 == x && j+2 == y) || (i-1 == x && j-2 == y)) {
                    cnt++;
                }
                if((i+2 == a && j+1 == b) || (i+2 == a && j-1 == b) || (i-2 == a && j+1 == b) || (i-2 == a && j-1 == b) || (i+1 == a && j+2 == b) || (i+1 == a && j-2 == b) || (i-1 == a && j+2 == b) || (i-1 == a && j-2 == b)) {
                    cnt++;
                }
                if(cnt == 2) {
                    ans = true;
