...
int32_t main() {
    ...
    while(t--) {
        ...
        for(int i = 0; i < n-2; i += 2) {
            if(s[i] == '1' && s[i+1] == '1' && s[i+2] == '1') ans *= 2;
            else if(s[i] == '1' && s[i+1] == '0' && s[i+2] == '1') ans *= 2;
            else if(s[i] == '0' && s[i+1] == '1' && s[i+2] == '1') ans *= 2;
            else if(s[i] == '0' && s[i+1] == '0' && s[i+2] == '1') ans *= 0;
            else if(s[i] == '1' && s[i+1] == '1' && s[i+2] == '0') ans *= 1;
            else if(s[i] == '1' && s[i+1] == '0' && s[i+2] == '0') ans *= 1;
            else if(s[i] == '0' && s[i+1] == '1' && s[i+2] == '0') ans *= 1;
            else if(s[i] == '0' && s[i+1] == '0' && s[i+2] == '0') ans *= 3;
            ans %= mod;
        }
        cout << ans << endl;
    }
